# -*- coding: utf-8 -*-
"""
Created on Sun Dec  2 22:48:47 2018
...
def generator(samples,batch_size=32):
    """
    Generates the training data and labels after data augmentation
    """
    num_samples=len(samples)
    while 1: # Loop forever so the generator never terminates
        shuffle(samples)#random sort
...
#resize the image data to accelerate the training step.
